...
export function updateSpot(spotId: string, record: {
  available?: boolean;
  cost?: number;
  suitableFor?: string[];
  electricChargerIdList?: string[];
...
export function updateChargingPort(chargingPortId: string, record: {
  available?: boolean;
  cost?: number;
  power?: number;
}): Promise<{ status: string }>;
...
export function getKnownPortTypes(): Promise<{ status: string; portTypes: object[] }>;
export function getAvailableSpot(parkingId?: string): Promise<{ status: string; parkings: object[] }>;
export function rentSpot(spotId:string, chargingPortId:string): Promise<{ status: string }>;
export function finishRent(rentId:string, billingSettingsId?:string): Promise<{ status: string; totalPrice: number }>;
